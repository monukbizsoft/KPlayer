...
import com.kbizsoft.KPlayer.media.MediaPlayerEventListener
import com.kbizsoft.KPlayer.media.PlayerController
import com.kbizsoft.resources.KPlayerInstance
import com.kbizsoft.KPlayer.util.random
    ...
    private inner class PreviewSession(context: Context
        ...
        override fun onTune(uri: Uri): Boolean {
            ...
            launch {
                ...
                try {
                    val media = factory.getFromUri(KPlayerInstance.getInstance(this@PreviewVideoInputService), mw.uri)
