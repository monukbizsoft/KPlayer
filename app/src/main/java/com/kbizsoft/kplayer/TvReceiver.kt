 ...
 * TvReceiver.java
 *
 * Copyright © 2014-2015 KPlayer authors, VideoLAN and VideoLabs
...
import com.kbizsoft.KPlayer.util.launchChannelUpdate
import com.kbizsoft.KPlayer.util.setChannel
...
class TvReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        private const val TAG = "KPlayer/TvReceiver"
