 ...
 *
 * Copyright © 2013-2015 KPlayer authors and VideoLAN
...
class MediaWrapperList {
    ...
    override fun toString(): String {
        ...
        sb.append("LibKPlayer Media List: {")
        ...
        sb.append("}")
        Log.e("kbtestMob", "toString" + sb.toString());
        return sb.toString()
    }

    companion object {
        private const val TAG = "KPlayer/MediaWrapperList"
