...
import com.kbizsoft.resources.interfaces.IMediaContentResolver
import com.kbizsoft.resources.interfaces.ResumableList
import com.kbizsoft.resources.util.getFromMl
import com.kbizsoft.tools.AppScope
import com.kbizsoft.tools.Settings
import com.kbizsoft.tools.localBroadcastManager
import com.kbizsoft.tools.markBidi
...
import com.kbizsoft.KPlayer.gui.dialogs.SubtitleDownloaderDialogFragment
import com.kbizsoft.KPlayer.providers.medialibrary.FoldersProvider
import com.kbizsoft.KPlayer.providers.medialibrary.MedialibraryProvider
import com.kbizsoft.KPlayer.providers.medialibrary.VideoGroupsProvider
...
private const val TAG = "KPlayer/MediaUtils"
...
object MediaUtils {
    ...
    suspend fun useAsSoundFont(context: Context, uri:Uri) {
        withContext(Dispatchers.IO) {
            FileUtils.copyFile(File(uri.path), KPlayerOptions.getSoundFontFile(context))
        }
    }
}
