 ...
 * *************************************************************************
 *  Copyright © 2016-2020 KPlayer authors and VideoLAN
...
import com.kbizsoft.KPlayer.ArtworkProvider
import com.kbizsoft.KPlayer.BuildConfig
import com.kbizsoft.KPlayer.R
import com.kbizsoft.KPlayer.gui.helpers.MediaComparators
import com.kbizsoft.KPlayer.gui.helpers.MediaComparators.formatArticles
import com.kbizsoft.KPlayer.isPathValid
import com.kbizsoft.KPlayer.media.MediaUtils.getMediaAlbum
import com.kbizsoft.KPlayer.media.MediaUtils.getMediaArtist
import com.kbizsoft.KPlayer.media.MediaUtils.getMediaSubtitle
import com.kbizsoft.KPlayer.util.TextUtils
import com.kbizsoft.KPlayer.util.ThumbnailsProvider
import com.kbizsoft.KPlayer.util.isSchemeStreaming
 ...
 *
 * Root node
 * //com.kbizsoft.KPlayer/{r}oot[?{f}latten=1]
 * Root menu
 * //com.kbizsoft.KPlayer/{r}oot/home
 * //com.kbizsoft.KPlayer/{r}oot/playlist/<id>
 * //com.kbizsoft.KPlayer/{r}oot/{l}ib
 * //com.kbizsoft.KPlayer/{r}oot/stream
 * Home menu
 * //com.kbizsoft.KPlayer/{r}oot/home/shuffle_all
 * //com.kbizsoft.KPlayer/{r}oot/home/last_added[?{i}ndex=<track num>]
 * //com.kbizsoft.KPlayer/{r}oot/home/history[?{i}ndex=<track num>]
 * Library menu
 * //com.kbizsoft.KPlayer/{r}oot/{l}ib/a{r}tist[?{p}age=<page num>]
 * //com.kbizsoft.KPlayer/{r}oot/{l}ib/a{r}tist/<id>
 * //com.kbizsoft.KPlayer/{r}oot/{l}ib/a{l}bum[?{p}age=<page num>]
 * //com.kbizsoft.KPlayer/{r}oot/{l}ib/a{l}bum/<id>
 * //com.kbizsoft.KPlayer/{r}oot/{l}ib/{t}rack[?{p}age=<page num>]
 * //com.kbizsoft.KPlayer/{r}oot/{l}ib/{t}rack[?{p}age=<page num>][&{i}ndex=<track num>]
 * //com.kbizsoft.KPlayer/{r}oot/{l}ib/{g}enre[?{p}age=<page num>]
 * //com.kbizsoft.KPlayer/{r}oot/{l}ib/{g}enre/<id>
 * Media
 * //com.kbizsoft.KPlayer/media/<id>
 * Errors
 * //com.kbizsoft.KPlayer/error/media
 * //com.kbizsoft.KPlayer/error/playlist
 * Search
 * //com.kbizsoft.KPlayer/search?query=<query>
 */
class MediaSessionBrowser {

    companion object {
        private const val TAG = "KPlayer/MediaSessionBrowser"
