...
import com.kbizsoft.libkplayer.LibKPlayer
import com.kbizsoft.libkplayer.util.AndroidUtil
import com.kbizsoft.medialibrary.MLServiceLocator
import com.kbizsoft.medialibrary.interfaces.DevicesDiscoveryCb
import com.kbizsoft.medialibrary.interfaces.Medialibrary
import com.kbizsoft.medialibrary.stubs.StubMedialibrary
import com.kbizsoft.resources.*
import com.kbizsoft.resources.util.dbExists
...
import com.kbizsoft.KPlayer.gui.SendCrashActivity
...
private const val TAG = "KPlayer/MediaParsingService"
...
class MediaParsingService : LifecycleService(), DevicesDiscoveryCb {
    ...
    override fun onCreate() {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "KPlayer:MediaParsingService")
        ...
        for (action in channel) when (action) {
            ...
            is Init -> {
                if (medialibrary.isInitiated) {
                    ...
                    medialibrary.setLibKPlayerInstance((KPlayerInstance.getInstance(context) as LibKPlayer).instance)
