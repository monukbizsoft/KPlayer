...
import com.kbizsoft.tools.CloseableUtils
import com.kbizsoft.tools.Logcat
...
import com.kbizsoft.KPlayer.gui.preferences.search.PreferenceParser
...
class DebugLogService : Service(), Logcat.Callback, Runnable {
    ...
    private fun forceForeground() {
        ...
        val builder = NotificationCompat.Builder(this, NotificationHelper.KPlayer_DEBUG_CHANNEL)
        ...
        builder.setSmallIcon(R.drawable.ic_stat_kplayer)
    ...
    override fun run() {
        ...
        val filename = AndroidDevices.EXTERNAL_PUBLIC_DIRECTORY + "/kplayer_logcat_" + timestamp + ".log"
        var saved = true
        ...
        try {
            ...
            synchronized(this) {
                ...
                bw.write("____________________________\r\n")
                bw.write("App version: ${BuildConfig.KPlayer_VERSION_CODE} / ${BuildConfig.KPlayer_VERSION_NAME}\r\n")
                bw.write("libkplayer: ${BuildConfig.LIBKPlayer_VERSION}\r\n")
                bw.write("libkplayer revision: ${getString(R.string.build_libkplayer_revision)}\r\n")
                bw.write("KPlayer revision: ${getString(R.string.build_kplayer_revision)}\r\n")
                ...
                bw.write("____________________________\r\n")
                bw.write("KPlayer options: ${KPlayerOptions.libOptions.joinToString(" ")}\r\n")
                bw.write("____________________________\r\n")
                for (line in logList) {
                    bw.write(line)
                    bw.newLine()
