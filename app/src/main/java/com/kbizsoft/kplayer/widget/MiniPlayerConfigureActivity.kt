...
import com.kbizsoft.KPlayer.databinding.WidgetMiniPlayerConfigureBinding
import com.kbizsoft.KPlayer.gui.BaseActivity
import com.kbizsoft.KPlayer.gui.dialogs.WidgetExplanationDialog
import com.kbizsoft.KPlayer.gui.helpers.bitmapFromView
import com.kbizsoft.KPlayer.gui.preferences.widgets.PreferencesWidgets
import com.kbizsoft.KPlayer.gui.preferences.widgets.WIDGET_ID
        ...
        model.widget.value?.let {widget ->
            lifecycleScope.launch {
                withContext((Dispatchers.IO)) {
                        val coverBitmap = BitmapFactory.decodeResource(resources, R.drawable.kplayer_fake_cover)
