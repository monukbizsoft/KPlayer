...
import com.kbizsoft.medialibrary.media.MediaLibraryItem.TYPE_MEDIA
import com.kbizsoft.medialibrary.media.MediaLibraryItem.TYPE_STORAGE
...
import com.kbizsoft.KPlayer.databinding.BrowserItemSeparatorBinding
import com.kbizsoft.KPlayer.databinding.CardBrowserItemBinding
...
import com.kbizsoft.KPlayer.util.getDescriptionSpan
...
open class BaseBrowserAdapter(val browserContainer: BrowserContainer<MediaLibraryItem>, var sort:Int = Medialibrary.SORT_FILENAME, var asc:Boolean = true) : DiffUtilAdapter<MediaLibraryItem, BaseBrowserAdapter.ViewHolder<ViewDataBinding>>(), MultiSelectAdapter<MediaLibraryItem>, FastScroller.SeparatedAdapter {
    ...
    protected val TAG = "KPlayer/BaseBrowserAdapter"
