...
package com.kbizsoft.KPlayer.gui.view
...
import com.kbizsoft.tools.CUSTOM_POPUP_HEIGHT
...
class PopupLayout : ConstraintLayout, ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener {
    ...
    private var kplayerVout: IKPlayerVout? = null
    ...
    fun setKPlayerVOut(vout: IKPlayerVout) {
        kplayerVout = vout
        kplayerVout!!.setWindowSize(popupWidth, popupHeight)
    }
    ...
    companion object {
        private const val TAG = "KPlayer/PopupView"
    }
}
