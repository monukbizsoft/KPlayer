...
import com.kbizsoft.KPlayer.gui.audio.AudioPlayer
import com.kbizsoft.KPlayer.gui.audio.AudioPlaylistTipsDelegate
import com.kbizsoft.KPlayer.gui.audio.AudioTipsDelegate
...
private const val TAG = "KPlayer/APCActivity"
...
open class AudioPlayerContainerActivity : BaseActivity(), KeycodeListener, SchedulerCallback {
    ...
    protected open fun initAudioPlayerContainerActivity() {
        ...
        tabLayout?.viewTreeObserver?.addOnGlobalLayoutListener {
            ...
            val needToElevate = false //(tabLayout?.layoutParams?.height != 0) || navigationRail?.visibility ?: View.GONE != View.GONE
    ...
    private fun initAudioPlayer() {
        ...
        playerBehavior.setLayoutListener {
            ...
            // That why we wait that the layout has been done to perform this. See https://code.kbizsoft.com/kbizsoft/KPlayer-android/-/issues/2241#note_291050
