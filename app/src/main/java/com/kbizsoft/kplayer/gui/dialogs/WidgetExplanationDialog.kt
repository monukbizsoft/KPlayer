...
import com.kbizsoft.KPlayer.databinding.DialogWidgetExplanationBinding
...
class WidgetExplanationDialog : KPlayerBottomSheetDialogFragment(), SchedulerCallback  {
    ...
    private val sizeDrawables = listOf(R.drawable.kplayer_widget_mini, R.drawable.kplayer_widget_micro, R.drawable.kplayer_widget_pill, R.drawable.kplayer_widget_macro)
    var currentDrawable = R.drawable.kplayer_widget_macro
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val sizeDrawbles = listOf(R.drawable.kplayer_widget_mini, R.drawable.kplayer_widget_micro, R.drawable.kplayer_widget_pill, R.drawable.kplayer_widget_macro)
