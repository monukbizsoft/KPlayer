...
import com.kbizsoft.KPlayer.gui.helpers.Click
import com.kbizsoft.KPlayer.gui.helpers.ImageClick
import com.kbizsoft.KPlayer.gui.helpers.LongClick
import com.kbizsoft.KPlayer.gui.helpers.SimpleClick
import com.kbizsoft.KPlayer.gui.helpers.UiTools.showDonations
import com.kbizsoft.KPlayer.gui.network.IStreamsFragmentDelegate
import com.kbizsoft.KPlayer.gui.network.KeyboardListener
import com.kbizsoft.KPlayer.gui.network.MRLAdapter
import com.kbizsoft.KPlayer.gui.network.StreamsFragmentDelegate
...
import com.kbizsoft.KPlayer.interfaces.IHistory
...
import com.kbizsoft.KPlayer.viewmodels.HistoryModel
import com.kbizsoft.KPlayer.viewmodels.StreamsModel

private const val TAG = "KPlayer/HistoryFragment"
...
//        KPlayerBilling.getInstance(requireActivity().application).addStatusListener {
...
//         if (KPlayerBilling.getInstance(requireActivity().application).status == BillingStatus.FAILURE ||  KPlayerBilling.getInstance(requireActivity().application).skuDetails.isEmpty()) donationsButton.setGone() else donationsButton.setVisible()
    }
