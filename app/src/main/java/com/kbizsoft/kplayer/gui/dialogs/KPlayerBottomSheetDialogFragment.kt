...
abstract class KPlayerBottomSheetDialogFragment : BottomSheetDialogFragment() {

    override fun onCreate(savedInstanceState: Bundle?) {
        if (Settings.showTvUi) {
            requireActivity().setTheme(R.style.Theme_KPlayer_Black)
        }
    ...
    private fun applyOverscanMargin(view: View) {
        val vm = requireActivity().resources.getDimensionPixelSize(com.kbizsoft.resources.R.dimen.tv_overscan_vertical)
