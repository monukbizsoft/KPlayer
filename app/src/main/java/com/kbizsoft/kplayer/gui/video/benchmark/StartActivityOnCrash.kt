...
class StartActivityOnCrash internal constructor(private val context: Activity) : Thread.UncaughtExceptionHandler {
    ...
    companion object {
        ...
        private const val SHARED_PREFERENCE = "org.videolab.KPlayer.gui.video.benchmark.UNCAUGHT_EXCEPTIONS"
        private const val SHARED_PREFERENCE_STACK_TRACE = "org.videolab.KPlayer.gui.video.benchmark.STACK_TRACE"
