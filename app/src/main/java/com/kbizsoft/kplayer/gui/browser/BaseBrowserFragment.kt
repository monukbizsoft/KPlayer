...
import com.kbizsoft.KPlayer.databinding.DirectoryBrowserBinding
...
import com.kbizsoft.KPlayer.gui.dialogs.SavePlaylistDialog
...
import com.kbizsoft.KPlayer.util.isSchemeSupported
import com.kbizsoft.KPlayer.util.isTalkbackIsEnabled
import com.kbizsoft.KPlayer.viewmodels.browser.BrowserModel
import java.util.*

private const val TAG = "KPlayer/BaseBrowserFragment"
    ...
    override fun setBreadcrumb() {
        ...
        if (media != null && isSchemeSupported(media.uri?.scheme)) {
            ...
            if (ariane.itemDecorationCount == 0) {
                ariane.addItemDecoration(KPlayerDividerItemDecoration(requireContext(), DividerItemDecoration.HORIZONTAL, ContextCompat.getDrawable(requireContext(), R.drawable.ic_divider)!!))
            }
