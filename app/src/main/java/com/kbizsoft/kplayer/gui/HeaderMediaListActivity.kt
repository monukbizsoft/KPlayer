...
import com.kbizsoft.KPlayer.databinding.HeaderMediaListActivityBinding
import com.kbizsoft.KPlayer.gui.audio.AudioAlbumTracksAdapter
...
import com.kbizsoft.KPlayer.gui.helpers.ExpandStateAppBarLayoutBehavior
import com.kbizsoft.KPlayer.gui.helpers.SwipeDragItemTouchHelperCallback
...
import com.kbizsoft.KPlayer.viewmodels.mobile.PlaylistViewModel
...
open class HeaderMediaListActivity : AudioPlayerContainerActivity(), IEventsHandler<MediaLibraryItem>, IListEventsHandler, ActionMode.Callback, View.OnClickListener, CtxActionReceiver, Filterable, SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {
    ...
    companion object {
        ...
        const val TAG = "KPlayer/PlaylistActivity"
    }
