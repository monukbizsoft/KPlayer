...
import com.kbizsoft.libkplayer.util.HWDecoderUtil
import com.kbizsoft.resources.AndroidDevices
import com.kbizsoft.resources.KPlayerInstance
import com.kbizsoft.tools.AUDIO_DUCKING
import com.kbizsoft.tools.LocaleUtils
import com.kbizsoft.tools.RESUME_PLAYBACK
...
import com.kbizsoft.KPlayer.gui.browser.FilePickerActivity
import com.kbizsoft.KPlayer.gui.browser.KEY_PICKER_TYPE
import com.kbizsoft.KPlayer.gui.helpers.UiTools
import com.kbizsoft.KPlayer.gui.helpers.restartMediaPlayer
import com.kbizsoft.KPlayer.isKPlayer4
import com.kbizsoft.KPlayer.media.MediaUtils
import com.kbizsoft.KPlayer.providers.PickerType
import com.kbizsoft.KPlayer.util.LocaleUtil
import java.text.DecimalFormat
import java.text.DecimalFormatSymbols
import java.util.Locale

private const val TAG = "KPlayer/PreferencesAudio"
...
class PreferencesAudio : BasePreferenceFragment(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isKPlayer4() && Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
        ...
        when (key) {
            ...
            "audio-replay-gain-enable", "audio-replay-gain-mode", "audio-replay-gain-peak-protection" -> lifecycleScope.launch { restartLibKPlayer() }
                ...
                try {
                    ...
                    if (fmtValue != newValue) {
                        sharedPreferences?.edit {
                            // putString will trigger another preference change event. Restart libKPlayer when it settles.
                            putString(key, fmtValue)
                            findPreference<EditTextPreference>(key)?.let { it.text = fmtValue }
                        }
                    } else lifecycleScope.launch { restartLibKPlayer() }
                }
            }
        }
    }
