...
import com.kbizsoft.KPlayer.gui.helpers.hf.getExtWritePermission
import com.kbizsoft.KPlayer.repository.ExternalSubRepository


object KPlayerDownloadManager: BroadcastReceiver(), DefaultLifecycleObserver {
    ...
    private fun getDownloadPath(subtitleItem: SubtitleItem) = "KPlayer/${subtitleItem.movieReleaseName}_${subtitleItem.idSubtitle}.zip"
