...
import com.kbizsoft.tools.FORCE_PLAY_ALL_AUDIO
import com.kbizsoft.tools.FORCE_PLAY_ALL_VIDEO
import com.kbizsoft.tools.KEY_APP_THEME
import com.kbizsoft.tools.KEY_CURRENT_MAJOR_VERSION
import com.kbizsoft.tools.KEY_CURRENT_SETTINGS_VERSION
import com.kbizsoft.tools.KEY_VIDEO_CONFIRM_RESUME
...
import com.kbizsoft.tools.toInt
...
object VersionMigration {
    ...
    val currentMajorVersion = if (isKPlayer4()) 4 else 3
    ...
    /**
     * Migration to KPlayer 4
     * ⚠️⚠️⚠️ This should not be destructive! Any first install will run this.
     */
    private fun migrateToKplayer4(settings: SharedPreferences) {
        Log.i(this::class.java.simpleName, "Migration to KPlayer 4")
